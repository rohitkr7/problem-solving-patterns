...
class Solution {
    ...
    public static void main(String[] args) {
        System.out.println(tripletSumCloseToTarget(new int[]{-2, 0, 1, 2}, 2)); // 1
        System.out.println(tripletSumCloseToTarget(new int[]{-3, -1, 1, 2}, 1)); // 0
        System.out.println(tripletSumCloseToTarget(new int[]{1, 0, 1, 1}, 100)); // 3
        System.out.println(tripletSumCloseToTarget(new int[]{-1, 2, 1, -4}, 1)); // 2
    }
}
````
...
class Solution {
    ...
    public static void main(String[] args) {
        System.out.println(tripletWithSmallerSum(new int[]{-1, 0, 2, 3}, 3)); // 2
        System.out.println(tripletWithSmallerSum(new int[]{-1, 4, 2, 1, 3}, 5)); // 4
        System.out.println(tripletWithSmallerSum(new int[]{-2, 0, 1, 3}, 2)); // 2
        System.out.println(tripletWithSmallerSum(new int[]{}, 0)); // 0
        System.out.println(tripletWithSmallerSum(new int[]{0}, 0)); // 0
    }
}
````
...
class Solution {
    public static int[] dutchFlagSort(int[] arr) {
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.toString(dutchFlagSort(new int[]{1, 0, 2, 1, 0}))); // [0, 0, 1, 1, 2]
        System.out.println(Arrays.toString(dutchFlagSort(new int[]{2, 2, 0, 1, 2, 0}))); // [0, 0, 1, 2, 2, 2]
    }
}
````
...
class Solution {
    ...
    public static void main(String[] args) {
        System.out.println(searchQuads(new int[]{4, 1, 2, -1, 1, -3}, 1)); // [[-3, -1, 1, 4], [-3, 1, 1, 2]]
        System.out.println(searchQuads(new int[]{2, 0, -1, 1, -2, 2}, 2)); // [[-2, 0, 2, 2], [-1, 0, 1, 2]]
    }
}
````
...
class Solution {
    ...
    public static void main(String[] args) {
        ...
        // true, After applying backspaces the strings become "x" and "x" respectively. 
        // In "xyz##", the first '#' removes the character 'z' and the second '#' removes the character 'y'.
        
        System.out.println(backspaceCompare("xywrrmp", "xywrrmu#p")); 
        // true, After applying backspaces the strings become "xywrrmp" and "xywrrmp" respectively.
    }
}
````
